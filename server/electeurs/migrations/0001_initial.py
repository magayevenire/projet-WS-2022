    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('candidature', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='electeurs.candidature')),
                ('electeur', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='votes', to='electeurs.electeur')),
            ],
            options={
